...
export const metadata: Metadata = {
  title: 'BMW 5 Series Wreckers Perth | Cash for 5 Series | Parts & Wrecking',
  description: 'Specialized BMW 5 Series wreckers in Perth. Best cash prices for all 5 Series models. Quality used parts in stock. Free car removal service across Perth.',
};

export default function BMW5SeriesPage() {
  const modelData = bmwData.models['5series'];
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <CommonIssues
            make="BMW"
            model="5 Series"
            issues={bmwData.commonIssues['5series'] || []}
          />
